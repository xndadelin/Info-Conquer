export const CircleNodes = () => {
    return (
        <svg fill="white" height={250} opacity={0.1} className="blur-md rotate-45 fixed left-[50%]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
