...
export const ProblemStats = () => {
    ...
    return (
        <div className="container flex-col">
                ...
                <Card className="p-7">
                    <div className="flex flex-col items-center">
                        ...
                        {data.getProblemStats.firstSubmissions[0] && data.getProblemStats.firstSubmissions[0]._id ? (
                            <Link to={`/profile/${data.getProblemStats.firstSubmissions[0]._id}`}>
                ...
                <Card className="p-7">
                    <div className="flex flex-col items-center">
                        ...
                        {data.getProblemStats.firstSubmissions[1] && data.getProblemStats.firstSubmissions[1]._id ? (
                            <Link to={`/profile/${data.getProblemStats.firstSubmissions[1]._id}`}>
                ...
                <Card className="p-7">
                    <div className="flex flex-col items-center">
                        ...
                        {data.getProblemStats.firstSubmissions[2] && data.getProblemStats.firstSubmissions[2]._id ? (
                            <Link to={`/profile/${data.getProblemStats.firstSubmissions[2]._id}`}>
            ...
            <h1 className="text-3xl font-bold mt-5">{t('problemStatsPage.bestMemoryTitle')}</h1>
