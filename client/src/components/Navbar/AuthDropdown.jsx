import { NavbarContent, Dropdown, DropdownTrigger, Avatar, DropdownMenu, DropdownItem, NavbarItem } from "@nextui-org/react";
            ...
            <NavbarItem>
                <Dropdown className="bg-gray-900">
                    ...
                    <DropdownMenu variant="flat">
                        ...
                        <DropdownItem className="text-blue-600 dark:text-blue-400">
                            <Link to={`/profile/${user.getUser.username}`}>
                        ...
                        {user?.getUser?.admin && (
                            adminSection.map((item) => (
                                <DropdownItem className="text-gray-600 dark:text-gray-400">
                                    <Link to={item.href}>
