...
const reports = require('./typeDefs/reports')

module.exports = mergeTypeDefs([user, article, solutions, problem, response, mutations, queries, announcement, contest, chatbot, reports])